          ...
          <Form onSubmit={handleSubmit(onSubmit)} style={{ margin: '0 40px' }}>
            ...
            <Form.Group as={Col} controlId="formGridEmail">
              ...
              <Form.Control
                ...
                {...register('email')} style={{ marginBottom: '20px' }}
              />
              <Form.Control.Feedback type="invalid">
            ...
            <Form.Group as={Col} controlId="formGridPassword">
              ...
              <Form.Control
                ...
                {...register('password')} style={{ marginBottom: '20px' }}
              />
              <Form.Control.Feedback type="invalid">
            ...
            <Form.Group as={Col} controlId="formGridPasswordConfirmation">
              ...
              <Form.Control
                ...
                {...register('password_confirmation')} style={{ marginBottom: '20px' }}
              />
              <Form.Control.Feedback type="invalid">
            ...
            <Button variant="primary" type="submit" disabled={status === statusList.process} style={{ textAlign: 'center', marginBottom: '30px', marginTop: '15px' }}>
